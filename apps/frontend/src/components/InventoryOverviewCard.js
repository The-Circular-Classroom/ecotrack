 ...
 */
export default function InventoryOverviewCard({ items = [], selectedItemType, selectedColor}) {
    ...
    const swatchIsLight = swatchColor === '#ffffff' || swatchColor === colourNameToHex('white');
