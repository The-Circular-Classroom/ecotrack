    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <div className="text-xs text-gray-500 mb-2 space-y-0.5">
          <p className="font-medium text-sm text-gray-700">{displayTotal.toLocaleString()} items</p>
          <p>School Stock: {(itemType?.schoolStock || 0).toLocaleString()}</p>
          <p>PSG Activities: {(itemType?.psgActivities || 0).toLocaleString()}</p>
          {isAdmin && (
            <>
