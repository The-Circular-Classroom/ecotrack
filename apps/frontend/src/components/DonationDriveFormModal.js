            ...
            <div className="flex flex-col gap-5 p-6">
                ...
                <div>
                    <label className={labelCls}>
                        Donation Drive Name<span className="text-red-500 ml-0.5">*</span>
                    </label>
                    <input
                        type="text"
                        name="driveName"
                        ...
                        placeholder="e.g. Annual Spring Food Drive"
                        className={errors.driveName ? inputErrorCls : inputCls}
                    />
                ...
                <div>
                    ...
                    <div className="relative">
                        ...
                        <input
                            ...
                            value={form.location}
                            onChange={handleChange}
                            placeholder="Street address or community hall"
                            className={`pl-9 ${errors.location ? inputErrorCls : inputCls}`}
                        />
                    </div>
