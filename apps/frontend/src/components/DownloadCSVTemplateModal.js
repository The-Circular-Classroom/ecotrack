...
export default function DownloadCSVTemplateModal({ isOpen, onClose, isAdmin }) {
  ...
  const locationInfo = {
    school: {
      ...
      columns: ["For PSG", "For School Stock", "For recycling/disposal"],
    },
    tcc: {
      label: "TCC",
      description: "Items sent to The Circular Classroom",
      columns: ["For PSG", "For Repurposing", "For recycling/disposal"],
    },
  };
      ...
      >
        ...
        <div className="flex justify-between items-center gap-3 p-4 border-t border-gray-200 flex-shrink-0">
          ...
          >
            {downloading
              ? "Downloading..."
              : `Download ${selectedLocation === "school" ? "School" : "TCC"}`}
          </CustomButton>
        </div>
      </div>
    </Backdrop>
